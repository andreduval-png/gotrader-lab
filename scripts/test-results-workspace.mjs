...
assert.match(view, /Estimated validation losses/);
assert.doesNotMatch(view, /label="Attributed avoidable losses"/);
assert.match(view, /Global local simulation ledger/);
assert.match(view, /countValue\(resultsSnapshot\.replay\.totalSignals\)/);
assert.match(view, /countValue\(resultsSnapshot\.walkForward\.oosTrades\)/);
assert.match(view, /countValue\(resultsSnapshot\.walkForward\.windowsPassed\)/);
assert.match(view, /countValue\(resultsSnapshot\.walkForward\.windows\)/);
assert.match(view, /countValue\(resultsSnapshot\.frozenProfile\.forwardCompleted\)/);
assert.match(view, /countValue\(resultsSnapshot\.monteCarlo\.usableOutcomes\)/);
assert.doesNotMatch(view, /String\(resultsSnapshot\.replay\.totalSignals\)/);
