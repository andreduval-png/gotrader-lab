...
import { ICT_MMBM_BASE_PARAMETERS } from "@/lib/ictI3/marketMakerParameters";
import type { IctI3DetectionInput, MarketMakerModelParameters } from "@/lib/ictI3/ictI3Types";

export const evaluateMarketMakerBuyModel = (
  input: IctI3DetectionInput,
  parameters: MarketMakerModelParameters = ICT_MMBM_BASE_PARAMETERS
) => evaluateMarketMakerModelCore(input, "BULLISH", parameters);

export const ICT_MMBM_CANONICAL_MODEL: CanonicalIctModel = assertCanonicalModelContract({
  ...
  narrativePolicyId: "c1.i3.mmbm-setup-maturation.v1",
  smtPolicy: "optional",
  parameterSchema: {
