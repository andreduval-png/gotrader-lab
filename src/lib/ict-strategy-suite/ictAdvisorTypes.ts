...
export interface IctAdvisorPacket {
  ...
  compactSummary: {
    ...
    analysisTimeframesRequested?: IctMarketAnalysisContext["analysisTimeframesRequested"];
    analysisTimeframesLoaded?: IctMarketAnalysisContext["analysisTimeframesLoaded"];
    requiredTimeframesLoaded?: IctMarketAnalysisContext["requiredTimeframesLoaded"];
    analysisDepthStatus?: IctMarketAnalysisContext["analysisDepthStatus"];
    multiTimeframeContextStatus?: IctMarketAnalysisContext["multiTimeframeContextStatus"];
