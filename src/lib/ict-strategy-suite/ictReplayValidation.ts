...
export const evaluateSignalOutcome = ({
  ...
  newsSessionRiskNotes: signal.newsSessionRisk?.newsSessionRiskNotes,
    ...
    modelDetected: signal.modelDetected,
    modelName: signal.modelName,
    modelState: signal.modelState,
    modelDirection: signal.modelDirection,
    modelConfidence: signal.modelConfidence,
    modelReasons: signal.modelReasons,
    modelMissingEvidence: signal.modelMissingEvidence,
