...
export const readLatestActivateMarketSummary = (): IctActivateMarketLatestSummary | undefined => {
  ...
  try {
    ...
    const summary: IctActivateMarketLatestSummary = {
      ...
      analysisTimeframesRequested: asList(parsed.analysisTimeframesRequested) as IctAnalysisTimeframe[],
      analysisTimeframesLoaded: asList(parsed.analysisTimeframesLoaded) as IctAnalysisTimeframe[],
      ...
      requiredTimeframesLoaded: parsed.requiredTimeframesLoaded === true,
      multiTimeframeContextStatus:
        typeof parsed.multiTimeframeContextStatus === "string" ? parsed.multiTimeframeContextStatus : undefined,
      weeklyBiasStatus: typeof parsed.weeklyBiasStatus === "string" ? parsed.weeklyBiasStatus : undefined,
      weeklyBiasDirection: typeof parsed.weeklyBiasDirection === "string" ? parsed.weeklyBiasDirection : undefined,
      weeklyBiasReason: typeof parsed.weeklyBiasReason === "string" ? parsed.weeklyBiasReason : undefined,
...
const buildLatestSummary = (
  ...
  analysisTimeframesRequested: result.summary.analysisTimeframesRequested,
  analysisTimeframesLoaded: result.summary.analysisTimeframesLoaded,
  analysisTimeframesUsed: result.summary.analysisTimeframesUsed,
  missingTimeframes: result.summary.missingTimeframes,
  requiredTimeframesLoaded: result.summary.requiredTimeframesLoaded,
  multiTimeframeContextStatus: result.summary.multiTimeframeContextStatus,
  weeklyBiasStatus: result.summary.weeklyBiasStatus,
  weeklyBiasDirection: result.summary.weeklyBiasDirection,
  weeklyBiasReason: result.summary.weeklyBiasReason,
