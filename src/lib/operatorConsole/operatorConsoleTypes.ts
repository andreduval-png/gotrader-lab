...
export interface OperatorResearchPlanSummary {
  ...
  planSource: "canonical_geometry" | "signal_contract" | "compatibility_projection" | "unavailable";
  planCoherence: "coherent" | "incomplete" | "incoherent";
  planCoherenceReason: string;
  candidateStatus?: string;
  entryZone?: { lower: number; upper: number };
  entryPrice?: number;
  entryPriceMethod?: "canonical_geometry" | "canonical_candidate" | "zone_midpoint";
  geometryId?: string;
