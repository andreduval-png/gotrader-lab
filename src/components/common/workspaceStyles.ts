/** Shared layout and surface classes for workspace pages (Phase 6 polish). */
export const WORKSPACE_PAGE = "mx-auto w-full max-w-[1560px] space-y-5 min-w-0";
export const WORKSPACE_CARD = "premium-surface-soft rounded-2xl";
export const WORKSPACE_CARD_ACCENT = "premium-surface rounded-2xl border-primary/25";
export const WORKSPACE_SECTION_LABEL =
  "text-[0.68rem] font-semibold uppercase tracking-[0.2em] text-slate-500";
